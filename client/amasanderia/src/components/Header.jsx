              ...
              <ul className="navbar-nav mt-3">
                ...
                <li className="nav-item">
                  <Link to="/contacto" className="nav-link mx-2">
                    <p className="font-roboto rounded px-1 py-1 b-hover">Contacto</p>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to="/conocenos" className="nav-link mx-2">
                    <p className="font-roboto rounded px-1 py-1 b-hover">Conócenos</p>
                  </Link>
                </li>
                <li className="nav-item">
